...
- [ ] Learn/understand and practice one core concept of React & JavaScript.
- [ ] Practice one DSA question atleast.
- [ ] Practice one leetCode question daily.

---

## 🧘‍♂️ Concepts to be learned + Note Making

- [ ]

---

## 🧘‍♂️ Leveraging AI (ChatGPT)

- [ ] Learn about AI, Data Science, Prompt Engineering.
- [ ] Go through LinkedIn learning, YouTube, Udemy etc.
- [ ] Find use case of AI in frontend development.

---

> ✅ Pro Tip: You can preview this file using `Ctrl+Shift+V` inside VS Code.
